...
all_messages = dict()
with open(os.path.join('considered_inputs_dir', 'message_fields_lte.txt'), 'r') as fr:
    lines = fr.readlines()
    in_message = False
    message_dict = dict()
...
with open(os.path.join('considered_inputs_dir', 'message_fields_lte.json'), 'w') as fw:
