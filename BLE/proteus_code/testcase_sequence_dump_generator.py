...
def check_condition_match(to_be_checked: str, checker_condition: str):
    # print(to_be_checked, checker_condition)
        ...
        if self.token_type == 1 or self.token_type == 2:
            ...
            if self.token_type == 3:
                ...
                for i in range(len(self.inp_tx)):
                    ...
                    # print(tbc_condition_msg, token_inp_msg)
                    # print(token_inp_msg + ":" + token_inp_fields)
                    # print(token_out_msg + ":" + token_out_fields)
                    # print(tbc_condition_input)
                    # print(tbc_condition_output)
...
def generate_testcase_dump(dump_filename,
                           ...
                           max_testcase_length):
    # qre_pool = list()
    # with open('qre_pool.txt', 'r') as fr:
    #     lines = fr.readlines()
    #     for line in lines:
    #         if ";" in line:
    #             qre_exp = line.split("\n")[0].strip()
    #             qre_pool.append(qre_exp)
    ...
    if ok:
        ...
        modified_qre_expression = "^[ ]*; " + modified_tok + "; "
